	...
	while(true) {
		...
		if(option < 0) {
			std::cout <<
				//"|===========================================================================================|" 
				"╠═══════════════════════════════════════════════════════════════════════════════════════════╣" << std::endl <<
				"    You entered a value that is too low  which even not exists, please try a higher value..  " << std::endl <<
				//"|===========================================================================================|" 
				"╠═══════════════════════════════════════════════════════════════════════════════════════════╣" << std::endl;
		}
		if(4 < option) {
			std::cout <<
				//"|============================================================================================|"
				"╠═══════════════════════════════════════════════════════════════════════════════════════════╣" << std::endl <<
				"    You entered a value that is too high which even not exists, please try a higher value..  " << std::endl <<
				//"|============================================================================================|"
				"╠═══════════════════════════════════════════════════════════════════════════════════════════╣" << std::endl;
		}
